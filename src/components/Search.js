...
if(character){
    ...
    return (
        <form className="flex-1 mb-4 sm:mb-0 flex items-center" onSubmit={handleSubmit}>
            <input type="number" placeholder="Enter a number ..." className={error?"rounded-l bg-red-200 pl-2 text-blue-500 text-xl border-red-700 border":"rounded-l bg-gray-200 pl-2 text-blue-500 text-xl" } value={character} onChange={(e)=>(setCharacter(e.target.value))}/>
